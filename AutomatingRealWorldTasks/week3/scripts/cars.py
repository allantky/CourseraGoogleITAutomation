...
def process_data(data):
  ...
  for item in data:
    ...
    if item["car"]["car_year"] not in yearly_sales:
      yearly_sales[item["car"]["car_year"]] = 0
    yearly_sales[item["car"]["car_year"]] += int(item["total_sales"])

  #print( max(yearly_sales.items(), key=operator.itemgetter(1))[0], max(yearly_sales.items()) )
...
def main(argv):
  ...
  reports.generate("/tmp/cars.pdf", "Sales summary for last month", summaryStr, table_data)
  # TODO: send the PDF report as an email attachment
  sender = "automation@example.com"
  receiver = "{}@example.com".format(os.environ.get('USER'))
  subject = "Sales summary for last month"
  body = summaryStr.replace('<br/>', '\n')
  #print(body)
